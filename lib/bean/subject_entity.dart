...
String urlStart = 'https://images.weserv.nl/?url=';
...
class Images {
  ...
  Images(String smallUrl, String largeUrl, String mediumUrl) {
    this.small = Constant.urlStart + smallUrl;  
    this.large = Constant.urlStart + largeUrl;  
    this.medium = Constant.urlStart + mediumUrl;  
  }
}
...
class Avatar {
  ...
  var large;
  var small;
  Avatar(String smallUrl, String largeUrl, String mediumUrl) {
    this.small = Constant.urlStart + smallUrl;  
    this.large = Constant.urlStart + largeUrl;  
    this.medium = Constant.urlStart + mediumUrl;
  }
