...
class TopItemBean {
  ...
  static TopItemBean convertWeeklyBeans(List<SubjectEntity> weeklyBeans) {
    String count = '每周五更新 · 共${math.min(weeklyBeans.length, 10)}部';
    String imgUrl = weeklyBeans[0].subject?.images?.large;
  ...
  static TopItemBean convertHotBeans(List<Subject> hotBeans) {
    String count = '每周五更新 · 共${math.min(10, hotBeans.length)}部';
