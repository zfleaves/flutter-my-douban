...
class ScoreStartWidget extends StatefulWidget {
  ...
  final p2;
  final p1;
  const ScoreStartWidget(
      {super.key, this.score, this.p5, this.p4, this.p3, this.p2, this.p1});

  @override
  State<ScoreStartWidget> createState() => _ScoreStartWidgetState();
}
              ...
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    RatingBar(widget.score, size: 11.0, fontSize: 0.0,)
                  ],
                ),
              ),
              Column(
