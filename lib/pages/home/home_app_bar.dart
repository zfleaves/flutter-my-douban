...
class _AppBarState extends State<AppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? centerStyle = widget.textTheme?.bodyLarge ?? themeData.primaryTextTheme.bodyLarge;
    TextStyle? sideStyle = widget.textTheme?.bodyLarge ?? themeData.primaryTextTheme.bodyLarge;
...
//    if (widget.bottom != null) {
    appBar = Column(
      ...
      children: <Widget>[
        ...
        widget.bottomOpacity == 1.0 ? (widget.bottom ?? Container()) : Opacity(
